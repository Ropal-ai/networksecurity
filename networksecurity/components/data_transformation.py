...
class DataTransformation:
    ...
    def get_data_tranfrom_obj(self)->Pipeline:
        logging.info("Entered get_data_transform_object method of transformation class")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        try:
            ...
            preprocessor = self.get_data_tranfrom_obj()
